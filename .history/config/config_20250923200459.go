...
func (c *ChainConfig) IsEmpty() bool {
	return !c.EnableChain &&
		...
		c.ChainRole == pb.ChainRole_CHAIN_ROLE_UNSPECIFIED &&
...
func (c *ChainConfig) ToProto() *pb.ChainConfig {
	return &pb.ChainConfig{
		...
		DefaultPrevShardId:        c.DefaultPrevShardID,
		FallbackNextShardId:       c.FallbackNextShardID,
...
func (c *ChainConfig) FromProto(pb *pb.ChainConfig) {
	...
	c.ChainRole = pb.ChainRole(pb.ChainRole)
}
