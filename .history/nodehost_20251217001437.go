...
func (nh *NodeHost) chainHealthChecker() {
	// ticker := time.NewTicker(nh.chain.config.HealthCheckInterval)

	// 使用 SyncIntervalMs 作为健康检查间隔（毫秒）
