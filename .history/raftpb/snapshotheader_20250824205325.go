...
func (m *SnapshotHeader) MarshalTo(dAtA []byte) (int, error) {
	...
	if m LeaderAddress != "" {
		...
		i++
		i = encodeVarint Raft(dAtA, i, uint64(len(m.LeaderAddress)))
